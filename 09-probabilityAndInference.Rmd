...
Answers to this exercise are at the end of the book. There are two points to these exercises. The first is that Venn diagrams should often be asymmetrical. The second is that problems about probability may be easier if we sketch them out using Venn diagrams.
