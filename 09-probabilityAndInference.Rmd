...
In general, P (B\|A) and P (A\|B) are not equivalent. Consider the following example

Answers to this exercise are at the end of the book. There are two points here: The first is that problems about probability may be easier if we sketch them out using Venn diagrams. The second is that Venn diagrams should often be asymmetrical.
