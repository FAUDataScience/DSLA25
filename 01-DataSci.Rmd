...
That is, we can think of **a *continuum* of mastery, including knowledge, skills, interests, and goals.** That continuum ranges from the data *consumer* to the data *citizen* to the data science *contributor.* Each aspect or type fo data science can be arranged in this hierarchy.

+----------------------+--------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------+
| Level                | Type A:\                                                                                         | Type B:\                                                                               | Type C: Conscientiousness                                                                                                 |
|                      | Analysis                                                                                         | Building                                                                               |                                                                                                                           |
+:====================:+:================================================================================================:+:======================================================================================:+:=========================================================================================================================:+
...
*Table: Data science as an array of levels of mastery and orientations.*
