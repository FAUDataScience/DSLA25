```{r setup22, echo=TRUE, message=FALSE, warning=FALSE}
...
1.  [Introduction to Networks with ggraph](https://rpubs.com/neloe/ggraph_intro "Neloe RPubs") and The Simpsons

2.  [Intro to Network Analysis in R](https://cbail.github.io/ids704/social-networks/Intro_to_Network_Analysis_in_R.html) (Bail, SICSS)

3.  [Network chapter](https://bookdown.org/jdholster1/idsr/network-analysis.html) (Holster, Laboratory for Interdisciplinary Statistical Analysis). A comprehensive introduction and links to a case study of network psychometrics.

4.  Bibliometric network videos (Lanning, see Chapter 23)
