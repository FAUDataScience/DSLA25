...
1.  [Introduction to Networks with ggraph](https://rpubs.com/neloe/ggraph_intro "Neloe RPubs")
...
3.  [Plutniak - igraph package](https://hal.science/hal-05115696v1/file/plutniak_2025_introduction-to-network-analysis-with-r-and-igraph.pdf)
4.  [Network chapter](https://bookdown.org/jdholster1/idsr/network-analysis.html) (Holster, Laboratory for Interdisciplinary Statistical Analysis)
5.  [Rawlings et al chapter](https://inarwhal.github.io/NetworkAnalysisR-book/ch3-Cross-Sectional-Network-Data-R.html)
